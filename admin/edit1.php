...
if (isset($_POST['insert_data'])) {
    ...
    if ($total != $total2) {
        ...
        $count = intval($row['count']);
            ...
            $update_query = "UPDATE `armoury` SET A='$A', B='$B', C='$C', D='$D', E='$E', F='$F', G='$G', H='$H' WHERE item='$item'";
    $result = mysqli_query($con, $update_query);

            if ($result_query) {
                echo "<script>alert('Successfully edited data into the Armoury.')</script>";
            } else {
...
<body class="bg-light" style="background:rgb(200,200,200)">
    <div class="container mt-5" >
        <h1 class="text-center p-5">Edit Data in Armoury 1</h1>
